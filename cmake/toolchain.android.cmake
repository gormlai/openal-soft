...
elseif(NDK_CPU_X86_64)
	set(ANDROID_NDK_CPU_NAME "x86_64")
...
include_directories(SYSTEM "${STL_PATH}/include" "${STL_LIBRARIES_PATH}/include" "${ANDROID_NDK}/sysroot/usr/include" "${ANDROID_NDK}/sysroot/usr/include/${ANDROID_TOOLCHAIN_PREFIX}")
